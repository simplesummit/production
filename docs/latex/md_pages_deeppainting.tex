...
\subsection*{Backend Installation and Setup}
...
\subsubsection*{Install remaining dependencies with pip}
...
\subsubsection*{Supervisord Installation}
...
\end{DoxyCode}
 \subsubsection*{Ensure that Supervisord is running}


\begin{DoxyCode}{0}
\DoxyCodeLine{\$ sudo service supervisor status}
\end{DoxyCode}
 \subsubsection*{Create Frontend and Backend Services}
...
\subsubsection*{Supervisord Web Interface}
