...
class MainHandler(tornado.web.RequestHandler):
    ...
    def set_default_headers(self):
        ...
        self.set_header("Access-Control-Allow-Origin", "*")
        self.set_header("Access-Control-Allow-Methods", "GET,PUT,POST")
        self.set_header("Access-Control-Allow-Headers", "Content-Type, Depth, User-Agent, X-File-Siz, X-Requested-With, X-Requested-By,If-Modified-Since, X-File-Name, Cache-Control")
